...
*/
#if is_rtc == 1
  #include "loom_rtc_new.h"
#endif
#if is_sd == 1
  #include "loom_sd_new.h"
#endif
#if is_adafruitio == 1
  #include "loom_adafruit_io_new.h"
#endif
#if is_sapflow == 1
  #include "loom_sapflowmeter_new.h"
#endif
...
// Files of functions that are not specific to sensors / actuators
  ...
  #include "loom_display_config_new.h"
#endif
/*
#if enable_hub_scripts == 1
  #include "loom_script_function_wrappers_new.h"
  #include "loom_hub_scripts_new.h"
#endif
*/
#include "loom_flash_new.h"
/*
#if advanced_interdev_comm == 1
  #include "loom_interdev_comm.h" 
#endif
*/
#include "loom_common_functions_new.h"
#include "loom_begin_new.h"
#include "loom_msg_router_new.h"
#include "loom_interface_new.h"
